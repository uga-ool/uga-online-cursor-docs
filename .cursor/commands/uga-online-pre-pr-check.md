...
Follow the **author track** in skill `uga-online-pr-and-code-review` and `docs/cursor/pr-and-code-review.md`.
...
2. **Secrets / FERPA** — Scan the diff for `.env`, API keys, tokens, student names, or UGA IDs in committed files or comments. Per `uga-online-secrets-and-ferpa.mdc`.
