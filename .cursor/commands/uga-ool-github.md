---
description: Plan or implement work using UGA OOL GitHub org repos and standards
---

You are working in the context of **UGA Online (OOL)** GitHub organization **uga-ool**.

**Browse org repos:** https://github.com/orgs/uga-ool/repositories

1. Prefer **reusing** existing OOL libraries and deployment patterns (Brightspace agents, Lit bundles, React course-file apps, Kaltura-related services) over introducing parallel stacks.
